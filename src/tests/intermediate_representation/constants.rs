...
#[test]
fn byte_code_for_signed_number_constant_generates_correctly() {
    ...
    assert_eq!(foreign_library_const_ir.symbols, vec!(absolute_external(string("STD_OUTPUT_HANDLE"), 0xFFFFFFF5)));    
